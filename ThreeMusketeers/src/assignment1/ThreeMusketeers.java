...
public class ThreeMusketeers {
    ...
    /**
     * This method undoes the last move made by a player in the game. It removes the last move from the list of moves made
     * and calls the undoMove method of the Board class to undo the move on the game board.
     * 
     * @precondition The list of moves made is not empty.
     * @postcondition The last move made by a player is undone and removed from the list of moves made.
     */
